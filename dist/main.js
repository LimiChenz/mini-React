...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return App; });\n/* harmony import */ var _zero_case_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./zero-case.js */ \"./zero-case.js\");\n/* harmony import */ var _compontens_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./compontens.js */ \"./compontens.js\");\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _iterableToArrayLimit(arr, i) { if (typeof Symbol === \"undefined\" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\n\n\nfunction App(props) {\n  var _Zero$useState = _zero_case_js__WEBPACK_IMPORTED_MODULE_0__[\"Zero\"].useState({\n    aaa: 'aaa',\n    bbb: 'bbb'\n  }),\n      _Zero$useState2 = _slicedToArray(_Zero$useState, 2),\n      message = _Zero$useState2[0],\n      changeMsg = _Zero$useState2[1];\n\n  var _Zero$useState3 = _zero_case_js__WEBPACK_IMPORTED_MODULE_0__[\"Zero\"].useState(true),\n      _Zero$useState4 = _slicedToArray(_Zero$useState3, 2),\n      show = _Zero$useState4[0],\n      changeShow = _Zero$useState4[1];\n\n  var _Zero$useState5 = _zero_case_js__WEBPACK_IMPORTED_MODULE_0__[\"Zero\"].useState(1),\n      _Zero$useState6 = _slicedToArray(_Zero$useState5, 2),\n      count = _Zero$useState6[0],\n      changeCount = _Zero$useState6[1];\n\n  function hello(e) {\n    var result = Math.random() * 10;\n    changeMsg({\n      aaa: result,\n      bbb: 'bbb'\n    });\n  }\n\n  var EVENTELEMENT = _zero_case_js__WEBPACK_IMPORTED_MODULE_0__[\"Zero\"].createElement(\"div\", {\n    style: {\n      marginTop: '20px'\n    }\n  }, _zero_case_js__WEBPACK_IMPORTED_MODULE_0__[\"Zero\"].createElement(\"button\", {\n    onClick: function onClick(e) {\n      hello(e);\n    }\n  }, message.aaa), _zero_case_js__WEBPACK_IMPORTED_MODULE_0__[\"Zero\"].createElement(\"div\", null, count), _zero_case_js__WEBPACK_IMPORTED_MODULE_0__[\"Zero\"].createElement(\"button\", {\n    onClick: function onClick(e) {\n      return changeShow(!show);\n    }\n  }, \"xxxx\"));\n  return _zero_case_js__WEBPACK_IMPORTED_MODULE_0__[\"Zero\"].createElement(\"div\", {\n    id: \"App\"\n  }, EVENTELEMENT, show ? _compontens_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"] : null);\n}\n\n//# sourceURL=webpack:///./template.js?");
